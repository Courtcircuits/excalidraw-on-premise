...
import { isSavedToSupabase, loadFilesFromSupabase, loadFromSupabase, saveFilesToSupabase, saveToSupabase } from "../data/supabase";
...
class Collab extends PureComponent<Props, CollabState> {
  ...
  saveCollabRoomToFirebase = async (
    ...
    try {
      ...
      const savedData = await saveToSupabase(
        this.portal,
        syncableElements,
